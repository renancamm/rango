...
# Thanks to Enzo Roiz https://github.com/enzoroiz
# who made these tests during an internship with us


class GeneralTests(TestCase):
    def test_serving_static_files(self):
        # If using static media properly result
        # is not NONE once it finds rango.jpg
        result = finders.find('images/rango-poster.jpg')
...
class IndexPageTests(TestCase):
    ...
    def test_rango_picture_displayed(self):
        ...
        # Chapter 4
        response = self.client.get(reverse('index'))
        self.assertIn(b'img src="/static/images/rango-poster.jpg',
                      response.content)
